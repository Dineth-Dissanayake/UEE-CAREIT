export default {
    icDropDown: require('../icons/arrow_drop_down.png'),
    ...
    JOBPOSTERIcon: require('../images/jobposter.png'),
    JOBSEEKERIcon: require('../images/jobseeker.png'),
    JOBSIcon:require('../images/JOBS.png'),
